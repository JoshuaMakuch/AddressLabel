...
Public Class AddressLabelForm
    ...
    Private Sub DisplayButton_Click(sender As Object, e As EventArgs) Handles DisplayButton.Click
        ...
        'Checks to make sure the user has at least put in something
        Dim textBoxes As String() = {FirstNameTextBox.Text, LastNameTextBox.Text, StreetAddressTextBox.Text, CityTextBox.Text, StateTextBox.Text, ZipTextBox.Text}
        If String.Join("", textBoxes).Length > 0 Then
