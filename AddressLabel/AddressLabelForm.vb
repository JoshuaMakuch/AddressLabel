...
Public Class AddressLabelForm
    ...
    Private Sub AddressLabelForm_Load(sender As Object, e As System.EventArgs) Handles MyBase.Load
        'Disables the display button until the user types in at least something
        DisplayButton.Hide()
    ...
    'Shows the display button so long as the user has typed in something into the first name box
